...
const Product = ({item}) => {
  return (
    <div>
        <div class="relative m-10 w-[305px] overflow-hidden rounded-lg bg-white shadow-md">
  <a href="#">
    <img class="h-60 rounded-t-lg object-cover" src={item.image}/>
  </a>
...
<div className='bg-red-400 text-center mx-16 py-2 rounded-lg text-white tracking-wider mb-4 cursor-pointer'>
<Link to={`/productDetails/${item.id}`}>More Details</Link>
